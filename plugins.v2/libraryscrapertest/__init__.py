...
class LibraryScrapertest(_PluginBase):
    # 插件名称
    plugin_name = "媒体库刮削test"
    # 插件描述
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "libraryscrapertest_"
    # 加载顺序
    plugin_order = 7
    # 可使用的用户级别
    user_level = 1
    ...
    def init_plugin(self, config: dict = None):
        ...
        if self._enabled or self._onlyonce:
            ...
            if self._onlyonce:
                ...
                self._scheduler.add_job(func=self.__libraryscrapertest, trigger='date',
    ...
    def get_service(self) -> List[Dict[str, Any]]:
        ...
        if self._enabled and self._cron:
            return [{
                "id": "LibraryScrapertest",
                "name": "媒体库刮削test",
                "trigger": CronTrigger.from_crontab(self._cron),
                "func": self.__libraryscrapertest,
                "kwargs": {}
            }]
        elif self._enabled:
            return [{
